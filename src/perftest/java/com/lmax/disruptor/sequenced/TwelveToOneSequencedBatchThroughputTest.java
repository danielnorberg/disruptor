 ...
 *
 */
public final class TwelveToOneSequencedBatchThroughputTest extends AbstractPerfTestDisruptor
{
    private static final int NUM_PUBLISHERS = 12;
    ...
    {
        new TwelveToOneSequencedBatchThroughputTest().testImplementations();
    }
}
